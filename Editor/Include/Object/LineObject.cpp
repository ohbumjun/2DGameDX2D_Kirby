...
{
	SetTypeID<CLineObject>();
}

CLineObject::CLineObject(const CLineObject& Obj) :
	CGameObject(Obj)
{
...
void CLineObject::SetStartPos(const Vector2& Pos)
{
	m_StartPos = Pos;
...
void CLineObject::SetEndPos(const Vector2& Pos)
{
	m_EndPos = Pos;
...
void CLineObject::Update(float DeltaTime)
{
...
void CLineObject::PostUpdate(float DeltaTime)
{
	CGameObject::PostUpdate(DeltaTime);
}

CLineObject* CLineObject::Clone()
{
	return new CLineObject(*this);
}

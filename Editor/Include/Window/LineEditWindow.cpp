...
bool CLineEditWindow::Init()
{
	...
	m_BackGroundImageLoadButton->SetClickCallback(this, &CLineEditWindow::BackGroundImageLoadButton);
	...
	Button->SetClickCallback<CLineEditWindow>(this, &CLineEditWindow::SetBackGroundScrollRatio);
...
void CLineEditWindow::BackGroundImageLoadButton()
{
...
void CLineEditWindow::SetBackGroundScrollRatio()
{
